...
using Sc2CustomOverlays.Code.Networking.Control.Commands;
...
namespace Sc2CustomOverlays.Code.Networking.Control
{
    ...
    class ControlService : INotifyPropertyChanged
    {
        ...
        #region Protected Event Handlers
            ...
            protected virtual void OverlaySettings_VariableUpdated(OverlayVariable ov)
            {
                if (Connection != null && EncryptedStream != null)
                {
                    Dictionary<string, object> updateParams = new Dictionary<string, object>();
                    updateParams["variableName"] = ov.VariableName;
                    updateParams["variableValue"] = ov.Value;
